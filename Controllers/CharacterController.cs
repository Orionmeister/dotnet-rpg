...
{
    [Authorize] //Makes all controller methods requires authorization. Can be added to top of specific methods too.
    [ApiController]
    [Route("[controller]")]
    public class CharacterController : ControllerBase
    {
        ...
        //[AllowAnonymous] Makes method not requiring authorization.
        [HttpGet("GetAll")]
